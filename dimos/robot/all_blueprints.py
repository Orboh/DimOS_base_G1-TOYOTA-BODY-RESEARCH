...
all_blueprints = {
    ...
    "unitree-go2-seat-demo": "dimos.robot.unitree.go2.blueprints.agentic.unitree_go2_seat_demo:unitree_go2_seat_demo",
    "unitree-go2-seat-demo-record": "dimos.robot.unitree.go2.blueprints.agentic.unitree_go2_seat_demo_record:unitree_go2_seat_demo_record",
    "unitree-go2-seat-demo-reuse": "dimos.robot.unitree.go2.blueprints.agentic.unitree_go2_seat_demo_reuse:unitree_go2_seat_demo_reuse",
...
all_modules = {
    ...
    "seat-finder-skill": "dimos.agents.skills.seat_finder.SeatFinderSkill",
    "seat-planner": "dimos.agents.skills.seat_planner.SeatPlanner",
