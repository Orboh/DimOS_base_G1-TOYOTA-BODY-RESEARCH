...
all_blueprints = {
    ...
    "unitree-g1-okra-honban": "dimos.robot.unitree.g1.blueprints.manipulation.unitree_g1_okra_honban:unitree_g1_okra_honban",
...
all_modules = {
    ...
    "isaac-zmq-depth-camera": "dimos.simulation.engines.isaac_zmq_camera.IsaacZmqDepthCamera",
    ...
    "sim-cmd-vel-bridge": "dimos.simulation.engines.sim_cmd_vel_bridge.SimCmdVelBridge",
