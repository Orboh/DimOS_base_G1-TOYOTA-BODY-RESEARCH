...
A common pattern is creating replay-based connection stubs for testing without hardware. From the upstream Go2 connection module ([`ReplayConnection`](https://github.com/dimensionalOS/dimos/blob/main/dimos/robot/unitree/go2/connection.py#L83)):
