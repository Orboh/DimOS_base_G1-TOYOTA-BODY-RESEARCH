...
BASKET = "/home/kota-ueda/Desktop/dimos-hackathon/usd_file/g1-29dof-dex1-base-fix-usd/basket_physics.usd"
...
for k, p in enumerate(prims):
    ...
    caught += inside
    lines.append(f"okra{k}: pos=({x:+.3f},{y:+.3f},{z:.3f}) r={rad:.3f} -> "
...
if ARGS.gui:
    ...
    while app.is_running():
        if k % period == 0:
            for prim, (x, y, z) in zip(prims, DROPS):
